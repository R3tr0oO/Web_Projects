...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h1> Remplir le formulaire pour supprimer une données.</h1><br>
    ...
    <a href="consultation.php"> Consulter une donnée </a><br><br>
        ...
        <form method="POST" action="verif_suppr.php" align="center">
          <p>Saisir l'id de votre cheval.</p>
          <input type="text" name="identite" id='identite' placeholder="identifiant">
          <br><br>
          <input class="btn-grad" type="submit" name="Supprimer">
        </form>
