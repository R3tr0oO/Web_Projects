...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <h1> Remplir le formulaire pour modifier une données.</h1><br>
    ...
    <a href="consultation.php"> Consulter une donnée </a><br><br>
        ...
        <form method="POST" action="verif_modif.php" align="center">
          <p>Saisir l'id de votre cheval.</p>
          <input type="number" name="identite" id='identite' placeholder="identifiant">
          <br>
